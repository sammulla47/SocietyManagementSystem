...
<form method="Post" action="HelpAction.jsp">
<div align="center" class="form-group">
<table>
<input type="Hidden" name="society" value="<%= request.getSession().getAttribute("SName") %>">

<input type="hidden" name="user" value="<%= request.getSession().getAttribute("Username") %>">

<tr><td>FlatId</td> <td><input type="text" name="flatid"  maxlength="50" size="20" required></td></tr>

<tr><td>Details</td> <td> <input type="text" name="details"  maxlength="50" size="20" required></td></tr>

<tr><td>DatePosted</td> <td><input type="date" name="datep"  maxlength="50" size="20" required></td></tr>

<tr><td>Images</td> <td> <input type="text" name="images"  maxlength="50" size="20" required></td></tr>

</table><table>
<tr><td colspan="2"><p align="center"><br/><input type="submit" class="btn btn-default" value="Add Help"></p></td></tr>
