					...
					<div class="panel panel-widget forms-panel">
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
	<%
		List<Flat> List = FlatWorker.getAllFlat();
	%>
	<div align="center" >
		<marquee>
		...
		<table border="2" cellspacing="1">
			<tr>
				...
				<th>Date Of Entry In Society</th>
				<th>UserId</th>
				<th>UserPass</th>
				<th>Current</th>
			</tr>
			...
			%>
			<tr>
				<th><a href="ShowByFlatId.jsp?id=<%=id%>"><%=fl.getId()%></a></th>
				
				<th><%=fl.getFlatId()%></th>
				<th><%=fl.getOwnerName()%></th>
				<th><%=fl.getPhoneNumber()%></th>
				<th><%=fl.getEmail()%></th>
				<th><%=fl.getImage()%></th>
				
				<th><%=fl.getEntryDate()%></th>
				<th><%=fl.getUserId()%></th>
				<th><%=fl.getUserPass()%></th>
				<th><%=fl.getCurrent()%></th>
			</tr>
			<%
					}
