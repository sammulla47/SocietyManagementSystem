...
<form method="Post" action="HospitalAction.jsp">
<div align="center" class="form-group">

<table>
<input type="Hidden" name="society" value="<%= request.getSession().getAttribute("SName")%>">

<tr><td>HospitalName</td> <td><input type="text" name="hospital"  maxlength="50" size="30"></td></tr>
...
<tr><td colspan="2"><p align="center"><br/><input type="submit" class="btn btn-default" value="Add Hospital"></p></td></tr>
