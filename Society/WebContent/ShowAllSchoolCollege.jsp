					...
					<div class="panel panel-widget forms-panel">
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
	<%
		List<SchoolCollege> List = SchoolCollegeWorker.getAllSchoolCollege();
	%>
	<div align="center">
		<marquee>
		...
		<table border="2" cellspacing="1">
			...
			<%
				for (SchoolCollege sc : List) {
					int id = sc.getId();
			%>
			<tr>
				<th><a href="ShowBySchoolCollegeId.jsp?id=<%=id%>"><%=sc.getId()%></a></th>
				...
				<th><%=sc.getPincode()%></th>
				<th><%=sc.getCity()%></th>
				<th><%=sc.getOpenTime()%></th>
				<th><%=sc.getClosedTime()%></th>
				<th><%=sc.getOpenDay()%></th>
				<th><%=sc.getClosedDay()%></th>
			<%
				}
			%>
		</table>
