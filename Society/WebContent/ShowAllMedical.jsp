					...
					<div class="panel panel-widget forms-panel">
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
	<%
		List<Medical> List = MedicalWorker.getAllMedical();
	%>
	<div align="center">
		<marquee>
		...
		<table border="2" cellspacing="1">
			...
			%>
			<tr>
				<th><a href="ShowByMedicalId.jsp?id=<%=id%>"><%=me.getId()%></a></th>
				...
				<th><%=me.getPincode()%></th>
				<th><%=me.getCity()%></th>
				<th><%=me.getOpenTime()%></th>
				<th><%=me.getClosedTime()%></th>
				<th><%=me.getOpenDay()%></th>
				<th><%=me.getClosedDay()%></th>
			<%
				}
			%>
		</table>
