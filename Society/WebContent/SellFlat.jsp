...
<form method="Post" action="SellFlatAction.jsp">
...
<tr><td>FlatId</td> <td><input type="number" name="flatid"  maxlength="50" size="20"></td></tr>

<tr><td>OwnerName</td> <td> <input type="text" name="owner"  maxlength="50" size="20"></td></tr>

<tr><td>Price</td> <td> <input type="number" name="price"  maxlength="50" size="20"></td></tr>

<tr><td>Details</td> <td><input type="text" name="details" maxlength="50" size="20"></td></tr>

<tr><td>Contact</td> <td><input type="number" name="contact" maxlength="50" size="20"></td></tr>

<tr><td colspan="2"><p align="center"><br/><input type="submit" class="btn btn-default" value="Add SellFlat"></p></td></tr>
</table>
</div>
</form>
</div>
