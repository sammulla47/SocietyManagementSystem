...
<h4>RailwayStation Update :</h4>
</div>
<div class="form-body">
	<form method="POST" action="UDRailwayStationAction.jsp">
		<%
			String i = request.getParameter("id");
			int id = Integer.parseInt(i);

			RailwayStation rs = RailwayStationWorker.getRailwayStationById(id);
		%>
<div align="center" class="form-group">
<table>

			<input type="hidden" name="sname" value="<%=rs.getSocietyName()%>">
			
<tr>
<td> Location:</td><td> <input type="text" name="location"value="<%=rs.getLocation()%>"> </td>
</tr><tr>
<td> KM:</td><td> <input type="text" name="km"value="<%=rs.getKM()%>"> </td>
</tr><tr>
<td>
