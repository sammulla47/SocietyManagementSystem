...
<h4>Facilities Update :</h4>
</div>
<div class="form-body">
	<form method="POST" action="UDFacilitiesAction.jsp">
		<%
			String i = request.getParameter("id");
			int id = Integer.parseInt(i);

			Facilities f = FacilitiesWorker.getFacilitiesById(id);
		%>
<div align="center" class="form-group">
<table>
<input type="Hidden" name="society" value="<%=f.getSocietyName()%>"> 
<tr>
<td> BookingId:</td><td> <input type="text" name="book"value="<%=f.getBookingId()%>"> </td>
</tr><tr>
<td> Booking:</td><td> <input type="text" name="booking"value="<%=f.getBooking()%>"> </td>
</tr><tr>
<td> Details:</td><td> <input type="text" name="details"value="<%=f.getDetails()%>"> </td>
</tr><tr>
<td> DateOfBooking:</td><td> <input type="date" name="datebook"value="<%=f.getDateOfBooking()%>"> </td>
</tr><tr>
<td> DateBooked:</td><td> <input type="date" name="datebooked"value="<%=f.getDateBook()%>"> </td>
</tr><tr>
<td> StartT:</td><td> <input type="time" name="start"value="<%=f.getStartTime()%>"> </td>
</tr><tr>
<td> EndT:</td><td> <input type="time" name="end"value="<%=f.getEndTime()%>"> </td>
</tr><tr>
<td>
