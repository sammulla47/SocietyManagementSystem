					...
					<div class="panel panel-widget forms-panel">
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
	<%
		List<Bank> List = BankWorker.getAllBank();
	%>
	<div align="center">
		<marquee>
		...
		<table border="2" cellspacing="1">
			...
			%>
			<tr>
				<th><a href="ShowByBankId.jsp?id=<%=id%>"><%=ba.getId()%></a></th>
				<th><%=ba.getBankName()%></th>
				<th><%=ba.getContact()%></th>
				<th><%=ba.getAddress()%></th>
				<th><%=ba.getPincode()%></th>
				<th><%=ba.getCity()%></th>
				<th><%=ba.getOpenTime()%></th>
				<th><%=ba.getClosedTime()%></th>
				<th><%=ba.getOpenDay()%></th>
				<th><%=ba.getClosedDay()%></th>
			<%
				}
			%>
		</table>
