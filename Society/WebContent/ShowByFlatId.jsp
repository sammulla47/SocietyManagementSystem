...
<div class="form-body">
	<form method="POST" action="UDFlatAction.jsp">
		<%
...
<table>
			...
			<input type="hidden" name="sname" value="<%=fl.getSocietyName()%>">
			
<tr>
<td> FlatID:</td><td> <input type="text" name="flatid"value="<%=fl.getFlatId()%>"> </td>
</tr><tr>
<td> OwnerName:</td><td> <input type="text" name="owner"value="<%=fl.getOwnerName()%>"> </td>
</tr><tr>
<td> PhoneNumber:</td><td> <input type="text" name="phone"value="<%=fl.getPhoneNumber()%>"> </td>
</tr><tr>
<td> Email:</td><td> <input type="email" name="email"value="<%=fl.getEmail()%>"> </td>
</tr><tr>
<td> Image:</td><td> <input type="text" name="images"value="<%=fl.getImage()%>"> </td>
</tr>
<td> EntryDate:</td><td> <input type="date" name="entry"value="<%=fl.getEntryDate()%>"> </td>
</tr><tr>
<td> UserId:</td><td> <input type="text" name="userid"value="<%=fl.getUserId()%>"> </td>
</tr><tr>
<td> UserPass:</td><td> <input type="text" name="userPass"value="<%=fl.getUserPass()%>"> </td>
</tr><tr>
<td>
				
			<br><font size="3" color="red">Note:- Before It On "<%=fl.getCurrent()%>" Now Can Update Click On Radio Button</font>
