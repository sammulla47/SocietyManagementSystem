...
<form method="Post" action="TheaterAction.jsp">
...
<tr><td>TheaterName</td> <td><input type="text" name="name"  maxlength="50" size="30"  required></td></tr>
...
<tr><td colspan="2"><p align="center"><br/><input type="submit" class="btn btn-default" value="Add Theater"></p></td></tr>
