					...
					<div class="panel panel-widget forms-panel">
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
<form method="Post" action="ATMAction.jsp">
<div align="center" calss="form-group">
<table>
<input type="hidden" name="society" value="<%= request.getSession().getAttribute("SName") %>">

<tr><td>Name Of ATM</td> <td><input type="text" name="atm"  maxlength="50" size="30" required></td></tr>

<tr><td>Location</td> <td> <input type="text" name="location"  maxlength="50" size="30" required></td></tr>

<tr><td>KM</td> <td><input type="number" name="km"  maxlength="50" size="30" required><br/><br/></td></tr>



<tr><td colspan="2"><p align="center"><input type="submit" class="btn btn-default" value="Add ATM"></p></td></tr>
</table>
</div>
</form>
</div>
