...
<title>Show All Society Registration</title>
</head>
						...
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								<div class="form-title">
									<h4>Show All Society Registration :</h4>
								</div>
								<div class="form-body">
	<%
		List<SocietyRegistration> List = SocietyRegistrationWorker.getAllSocietyRegistration();
	%>
	<div align="center">
		<marquee>
		...
		<table border="2" cellspacing="1">
			...
			<%
				for (SocietyRegistration sr : List) {
					int id = sr.getId();
			%>
			<tr>
				<th><a href="ShowBySocietyRegistrationId.jsp?id=<%=id%>"><%=sr.getId()%></a></th>
				<th><%=sr.getSID()%></th>
				<th><%=sr.getSPass()%></th>
