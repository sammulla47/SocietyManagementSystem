...
<h4>Theater Update :</h4>
</div>
<div class="form-body">
	<form method="POST" action="UDTheaterAction.jsp">
		<%
			String i = request.getParameter("id");
			int id = Integer.parseInt(i);

			Theater th = TheaterWorker.getTheaterById(id);
		%>
<div align="center" class="form-group">
<table>

			<input type="hidden" name="sname" value="<%=th.getSocietyName()%>">
			
<tr>
<td> TheaterName:</td><td> <input type="text" name="theatername"value="<%=th.getTheaterName()%>"> </td>
</tr><tr>
<td> Address:</td><td> <input type="text" name="address"value="<%=th.getAddress()%>"> </td>
</tr><tr>
<td> City:</td><td> <input type="text" name="city"value="<%=th.getCity()%>"> </td>
</tr><tr>
<td> Pincode:</td><td> <input type="text" name="pincode"value="<%=th.getPincode()%>"> </td>
</tr><tr>
