...
<form method="Post" action="EventAction.jsp">
<div align="center" class="form-group"> <br/><br/>
<table>

<tr><td>EventName</td> <td><input type="text" name="event" placeholder="eg:-Birthday Party/Society Repair" maxlength="50" size="30" required></td></tr>

<input type="Hidden" name="society" value="<%= request.getSession().getAttribute("SName") %>">

<tr><td>Topic</td> <td><input type="text" name="topic" placeholder="eg:-Details" maxlength="50" size="30" required></td></tr>

<tr><td>EventDate</td> <td> <input type="date" name="date"  maxlength="50" size="30"  required></td></tr>

<tr><td>StartTime</td> <td><input type="time" name="start" required></td></tr>

<tr><td>EndTime</td> <td> <input type="time" name="end" required></td></tr>

<tr><td>Place</td> <td> <input type="text" name="place" placeholder="eg:-Ground/Hall/Flat Number" maxlength="50" size="30" required></td></tr>

<tr><td colspan="2"><p align="center"><br/><input type="submit" class="btn btn-default" value="Add Event"></p></td></tr>
</table>
</div>
</form>
</div>
