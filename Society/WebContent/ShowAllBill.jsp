					...
					<div class="panel panel-widget forms-panel">
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
	<%
		List<Bill> List = BillWorker.getAllBill();
	%>
	<div align="center">
		...
		float y;%>
			<tr>
				...
				<th>CleaningP</th>
				<th>Monthly</th>
				<th>Year Amount Without Discount Total</th> 
				<th>Discount Present On Yearly Pay</th>
				<th>Discount Amount On Yearly Pay</th>
				<th>Yearly Amount With Discount Total</th>
			</tr>
			<%
				for (Bill b : List) {
					int id = b.getId();
			%>
			<tr>
				<th><a href="ShowByBillId.jsp?id=<%=id%>"><%=b.getId()%></a></th>
				
				<th><%=b.getSecurityP()%></th>
				<th><%=b.getLiftP()%></th>
				<th><%=b.getWaterP()%></th>
				<th><%=b.getCleaningP()%></th>
				<th><%=b.getMonthly()%></th>
				<th><%=x=b.getYear()%></th>
				<th><%=b.getDiscountP()%>%</th>
				<th><%=y=b.getDiscountA()%></th>
				<th><%out.print(x-y);%></th>
			</tr>
			<%
				}
