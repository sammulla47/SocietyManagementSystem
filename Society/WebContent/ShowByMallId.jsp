...
<div class="form-body">
	<form method="POST" action="UDMallAction.jsp">
		<%
			String i = request.getParameter("id");
			int id = Integer.parseInt(i);

			Mall m = MallWorker.getMallById(id);
		%>
<div align="center" class="form-group">
<table>

			<input type="hidden" name="sname" value="<%=m.getSocietyName()%>">
			
<tr>
<td> Name:</td><td> <input type="text" name="name"value="<%=m.getName()%>"> </td>
</tr><tr>
<td> Address:</td><td> <input type="text" name="address"value="<%=m.getAddress()%>"> </td>
</tr><tr>
<td> City:</td><td> <input type="text" name="city"value="<%=m.getCity()%>"> </td>
</tr><tr>
<td> Pincode:</td><td> <input type="text" name="pincode"value="<%=m.getPincode()%>"> </td>
</tr><tr>
<td> OpenTime:</td><td> <input type="text" name="opentime"value="<%=m.getOpenTime()%>"> </td>
</tr><tr>
<td> CloseTime:</td><td> <input type="text" name="closetime"value="<%=m.getClosedTime()%>"> </td>
</tr><tr>
