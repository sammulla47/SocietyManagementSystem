					...
					<div class="panel panel-widget forms-panel">
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
	<%
		List<RestaurantsHotels> List = RestaurantsHotelsWorker.getAllRestaurantsHotels();
	%>
	<div align="center">
		<marquee>
		...
		<table border="2" cellspacing="1">
			...
			<%
				for (RestaurantsHotels rh : List) {
					int id = rh.getId();
			%>
			<tr>
				<th><a href="ShowByRestaurantsHotelsId.jsp?id=<%=id%>"><%=rh.getId()%></a></th>
				...
				<th><%=rh.getPincode()%></th>
				<th><%=rh.getCity()%></th>
				<th><%=rh.getOpenTime()%></th>
				<th><%=rh.getClosedTime()%></th>
				<th><%=rh.getOpenDay()%></th>
				<th><%=rh.getClosedDay()%></th>
			<%
				}
			%>
		</table>
