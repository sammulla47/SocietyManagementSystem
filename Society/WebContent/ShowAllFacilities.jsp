						...
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								<div class="form-title">
									<h4>Show All Facilities :</h4>
								</div>
								<div class="form-body">
	<%
		List<Facilities> List = FacilitiesWorker.getAllFacilities();
	%>
	<div align="center">
		<marquee>
		...
		<table border="2" cellspacing="1">
			...
			%>
			<tr>
				<th><a href="ShowByFacilitiesId.jsp?id=<%=id%>"><%=f.getId()%></a></th>
				
				<th><%=f.getBookingId()%></th>
				<th><%=f.getBooking()%></th>
				<th><%=f.getDetails()%></th>
				<th><%=f.getDateOfBooking()%></th>
				<th><%=f.getDateBook()%></th>
				<th><%=f.getStartTime()%></th>
				<th><%=f.getEndTime()%></th>
			</tr>
			<%
				}
