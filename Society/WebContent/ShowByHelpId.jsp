...
<div class="form-body">
	<form method="POST" action="UDHelpAction.jsp">
		<%
			String i = request.getParameter("id");
			int id = Integer.parseInt(i);

			Help h = HelpWorker.getHelpById(id);
		%>
<div align="center" class="form-group">
<table>

			<input type="hidden" name="sname" value="<%=h.getSocietyName()%>">
			
<tr>
<td> UserName:</td><td> <input type="text" name="user"value="<%=h.getUserName()%>"> </td>
</tr><tr>
<td> FlatId:</td><td> <input type="text" name="faltId"value="<%=h.getFlatId()%>"> </td>
</tr><tr>
<td> Details:</td><td> <input type="text" name="detail"value="<%=h.getDetails()%>"> </td>
</tr><tr>
<td> DateP:</td><td> <input type="text" name="datep"value="<%=h.getDatePosted()%>"> </td>
</tr><tr>
<td> Image:</td><td> <input type="text" name="image"value="<%=h.getImage()%>"> </td>
</tr><tr>
<td>	
