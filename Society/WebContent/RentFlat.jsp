						...
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								<div class="form-title">
									<h4>Add Rent's Flat:</h4>
								</div>
								<div class="form-body">	
		
			

<form method="Post" action="RentFlatAction.jsp">
<div align="center" class="form-group">
<table>

<input type="hidden" type="text" name="society" value="<%= request.getSession().getAttribute("SName") %>">

<tr><td>Rent User Id</td> <td><input type="text" name="rid"  maxlength="50" size="20" required></td></tr>

<tr><td>Rent User Password</td> <td> <input type="text" name="rentPassword"  maxlength="50" size="20" required></td></tr>

<tr><td>FlatId</td> <td><input type="number" name="flatid"  maxlength="50" size="20" required></td></tr>

<tr><td>EntryDate</td> <td> <input type="date" name="entry"  maxlength="50" size="20" required></td></tr>

<tr><td>Agreement</td> <td><select name="agreement">
...
<tr><td>LeaveDate</td> <td><input type="date" name="leavedate" maxlength="50" size="20" required></td></tr>
</table>


<table>
<tr><td colspan="2"><p align="center"><br/><input type="submit" class="btn btn-default" value="Add RentFlat"></p></td></tr>
