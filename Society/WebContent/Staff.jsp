...
<form method="Post" action="StaffAction.jsp">
<div align="center" class="form-group">
<table>

<input type="hidden" type="text" name="society" value="<%= request.getSession().getAttribute("SName") %>">

<tr><td>Name</td> <td> <input type="text" name="name"  maxlength="50" size="20" required></td></tr>

<tr><td>Phone</td> <td> <input type="text" name="phone"  maxlength="50" size="20" required></td></tr>

<tr><td>Worker Details</td> <td><input type="text" name="worker" maxlength="50" size="20" required></td></tr>

<tr><td>Id Proof</td> <td><input type="text" name="idproof" maxlength="50" size="20" required></td></tr>

<tr><td>Photo</td> <td><input type="text" name="image" maxlength="50" size="20" required></td></tr>


<tr><td colspan="2"><p align="center"><br/><input type="submit" class="btn btn-default" value="Add Staff"></p></td></tr>
</table>
</div>
</form>
</div>
