...
<div class="form-body">
	<form method="POST" action="UDClinicAction.jsp">
		<%
			String i = request.getParameter("id");
			int id = Integer.parseInt(i);

			Clinic cl = ClinicWorker.getClinicById(id);
		%>

		<div align="center" class="form-group">
<table>

			<input type="hidden" name="sname" value="<%=cl.getSocietyName()%>">
			
			<tr>
<td>  ClinicName: </td><td><input type="text" name="clinicname" value="<%=cl.getClinicName()%>"></td>
</tr><tr>
<td>Address:</td><td> <input type="text" name="address" value="<%=cl.getAddress()%>"></td>
</tr><tr>
<td> City:</td><td> <input type="text" name="city" value="<%=cl.getCity()%>"></td>
</tr><tr>
<td>Pincode:</td><td> <input type="text" name="pincode" value="<%=cl.getPincode()%>"></td>
</tr><tr>
<td>OpenTime:</td><td> <input type="text" name="opentime" value="<%=cl.getOpenTime()%>"></td>
</tr><tr>
<td>CloseTime:</td><td> <input type="time" name="closetime" value="<%=cl.getClosedTime()%>"></td>
</tr><tr>
<td>OpenDay:</td><td> <input type="time" name="openday" value="<%=cl.getOpenDay()%>"></td>
</tr><tr>
<td>CloseDay:</td><td> <input type="text" name="closeDday" value="<%=cl.getClosedDay()%>"></td>
</tr><tr>
<td>			
