...
<h4>RentFlat Update :</h4>
</div>
<div class="form-body">
	<form method="POST" action="UDRentFlatAction.jsp">
		<%
			String i = request.getParameter("id");
			int id = Integer.parseInt(i);

			RentFlat rf = RentFlatWorker.getRentFlatById(id);
		%>
<div align="center" class="form-group">
<table>

			<input type="hidden" name="sname" value="<%=rf.getSocietyName()%>">
			
<tr>
			 <td>Rent User Id:</td><td> <input type="text" name="rid"value="<%=rf.getRentId()%>"> </td>
             </tr><tr>
		    <td> Rent User Password:</td><td> <input type="text" name="rentPassword"value="<%=rf.getRenterPass()%>"> </td>
            </tr><tr>
			 <td> FlatID:</td><td> <input type="text" name="flatid"value="<%=rf.getFlatId()%>"> </td>
             </tr><tr>
			 <td> Entry Date:</td><td> <input type="text" name="entry"value="<%=rf.getEntryDate()%>"> </td>
             </tr><tr>
			<td> Agreement: Before value="<%=rf.getAgreement()%>"
  ...
  <option   value="1 Year" >1 Year</option>
			...
			<td> LeaveDate:</td><td> <input type="text" name="leavedate"value="<%=rf.getLeaveDate()%>"> </td>
            </tr><tr>
            <td>
            
			 <input type="hidden" name="Id" value="<%=rf.getId()%>">
