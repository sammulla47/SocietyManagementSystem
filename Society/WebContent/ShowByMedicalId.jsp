...
<h4>Medical Update :</h4>
</div>
<div class="form-body">
	<form method="POST" action="UDMedicalAction.jsp">
		<%
			String i = request.getParameter("id");
			int id = Integer.parseInt(i);

			Medical me = MedicalWorker.getMedicalById(id);
		%>
<div align="center" class="form-group">
<table>

			<input type="hidden" name="sname" value="<%=me.getSocietyName()%>">
			
<tr>
<td> Name:</td><td> <input type="text" name="name"value="<%=me.getName()%>"> </td>
</tr><tr>
<td> Address:</td><td> <input type="text" name="address"value="<%=me.getAddress()%>"> </td>
</tr><tr>
<td> City:</td><td> <input type="text" name="city"value="<%=me.getCity()%>"> </td>
</tr><tr>
<td> Pincode:</td><td> <input type="text" name="pincode"value="<%=me.getPincode()%>"> </td>
</tr><tr>
<td> OpenTime:</td><td> <input type="text" name="opentime"value="<%=me.getOpenTime()%>"> </td>
</tr><tr>
<td> ClosedTime:</td><td> <input type="text" name="closetime"value="<%=me.getClosedTime()%>"> </td>
</tr><tr>
<td> OpenDay:</td><td> <input type="text" name="openday"value="<%=me.getOpenDay()%>"> </td>
</tr><tr>
<td> ClosedDay:</td><td> <input type="text" name="closeDday"value="<%=me.getClosedDay()%>"> </td>
</tr><tr>
<td>
