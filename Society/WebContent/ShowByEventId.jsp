...
<div class="form-body">
	<form method="POST" action="UDEventAction.jsp">
		<%
			...
			Event ev = EventWorker.getEventById(id);
		%>
<div align="center" class="form-group">
<table>
<input type="hidden" name="society" value="<%=ev.getSocietyName()%>"> 

			 <tr>
<td>EventName: </td><td><input type="text" name="event" value="<%=ev.getEventId()%>">
</td></tr>			 
			 <tr>
<td>Topic: </td><td><input type="text" name="topic" value="<%=ev.getTopic()%>"> 
</td></tr>			 
			 <tr>
<td>Date: </td><td><input type="text" name="date" value="<%=ev.getEventDate()%>"> 
</td></tr>
			 <tr>
<td>StartTime: </td><td><input type="time" name="start" value="<%=ev.getStartTime()%>"> 
</td></tr>
			<tr>
<td> EndTime: </td><td><input type="time" name="end" value="<%=ev.getEndTime()%>">
</td></tr>
			<tr>
<td>Place: </td><td><input type="text" name="place" value="<%=ev.getPlace()%>"> 
</td></tr>
