...
<div class="form-body">
	<form method="POST" action="UDStaff.jsp">
		<%
			String i = request.getParameter("id");
			int id = Integer.parseInt(i);

			Staff st = StaffWorker.getStaffById(id);
		%>
<div align="center" class="form-group">
<table>

			<input type="hidden" name="sname" value="<%=st.getSocietyName()%>">
			
<tr>
<td> Name:</td><td> <input type="text" name="name"value="<%=st.getName()%>"> </td>
</tr><tr>
<td> Phone:</td><td> <input type="text" name="phone"value="<%=st.getPhone()%>"> </td>
</tr><tr>
<td> Worker Details:</td><td> <input type="text" name="worker"value="<%=st.getWorkerD()%>"> </td>
</tr><tr>
<td> IdProof:</td><td> <input type="text" name="idproof"value="<%=st.getIdProof()%>"> </td>
</tr><tr>
<td> Image:</td><td> <input type="text" name="image"value="<%=st.getImage()%>"> </td>
</tr><tr>
<td>
