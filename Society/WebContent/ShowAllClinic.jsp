					...
					<div class="panel panel-widget forms-panel">
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
	<%
		List<Clinic> List = ClinicWorker.getAllClinic();
	%>
	<div align="center">
		<marquee>
		...
		<table border="2" cellspacing="1">
			...
			%>
			<tr>
				<th><a href="ShowByClinicId.jsp?id=<%=id%>"><%=cl.getId()%></a></th>
			
				<th><%=cl.getClinicName()%></th>
				<th><%=cl.getContact()%></th>
				<th><%=cl.getAddress()%></th>
				<th><%=cl.getPincode()%></th>
				<th><%=cl.getCity()%></th>
				<th><%=cl.getOpenTime()%></th>
				<th><%=cl.getClosedTime()%></th>
				<th><%=cl.getOpenDay()%></th>
				<th><%=cl.getClosedDay()%></th>
			<%
				}
			%>
		</table>
