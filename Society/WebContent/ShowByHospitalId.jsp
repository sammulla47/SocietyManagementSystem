...
<h4>Hospital Update :</h4>
</div>
<div class="form-body">
	<form method="POST" action="UDHospitalAction.jsp">
		<%
			String i = request.getParameter("id");
			int id = Integer.parseInt(i);

			Hospital ho = HospitalWorker.getHospitalById(id);
		%>
<div align="center" class="form-group">
<table>

			<input type="hidden" name="sname" value="<%=ho.getSocietyName()%>">
			
<tr>
<td> HospitalName:</td><td> <input type="text" name="hospitalname"value="<%=ho.getHospitalName()%>"> </td>
</tr><tr>
<td> Contact:</td><td> <input type="text" name="contact"value="<%=ho.getContact()%>"> </td>
</tr><tr>
<td> Address:</td><td> <input type="text" name="address"value="<%=ho.getAddress()%>"> </td>
</tr><tr>
<td> City:</td><td> <input type="text" name="city"value="<%=ho.getCity()%>"> </td>
</tr><tr>
<td> Pincode:</td><td> <input type="text" name="pincode"value="<%=ho.getPincode()%>"> </td>
</tr><tr>

<td>
                
			 <input type="hidden" name="Id" value="<%=ho.getId()%>">
