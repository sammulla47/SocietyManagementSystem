...
<title>Show All Sell Flat</title>
</head>
						...
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								<div class="form-title">
									<h4>Show All Sell Flat :</h4>
								</div>
								<div class="form-body">
	<%
		List<SellFlat> List = SellFlatWorker.getAllSellFlat();
	%>
	<div align="center">
		<marquee>
		...
		<table border="2" cellspacing="1">
			...
			<%
				for (SellFlat sf : List) {
					int id = sf.getId();
			%>
			<tr>
				<th><a href="ShowBySellFlatId.jsp?id=<%=id%>"><%=sf.getId()%></a></th>
				<th><%=sf.getFlatId()%></th>
				
				<th><%=sf.getOwnerName()%></th>
				<th><%=sf.getPrice()%></th>
				<th><%=sf.getDetails()%></th>
				<th><%=sf.getContact()%></th>
			</tr>
