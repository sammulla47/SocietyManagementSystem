...
<h4>SellFlat Update :</h4>
</div>
<div class="form-body">
	<form method="POST" action="UDSellFlatAction.jsp">
		<%
			String i = request.getParameter("id");
			int id = Integer.parseInt(i);

			SellFlat sf = SellFlatWorker.getSellFlatById(id);
		%>
<div align="center" class="form-group">
<table>

			<input type="hidden" name="sname" value="<%=sf.getSocietyName()%>">
			
<tr>
<td> FlatID:</td><td> <input type="text" name="flatid"value="<%=sf.getFlatId()%>"> </td>
</tr><tr>
<td> OwnerName:</td><td> <input type="text" name="owner"value="<%=sf.getOwnerName()%>"> </td>
</tr><tr>
<td> Price:</td><td> <input type="text" name="price"value="<%=sf.getPrice()%>"> </td>
</tr><tr>
<td> Details:</td><td> <input type="text" name="details"value="<%=sf.getDetails()%>"> </td>
</tr><tr>
<td> Contact:</td><td> <input type="text" name="contact"value="<%=sf.getContact()%>"> </td>
</tr><tr>
			
            
             <input type="hidden" name="Id" value="<%=sf.getId()%>">
