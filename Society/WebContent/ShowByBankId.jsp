...
<div class="form-body">
	<form method="POST" action="UDBankAction.jsp">
		<%
			String i = request.getParameter("id");
			int id = Integer.parseInt(i);

			Bank ba = BankWorker.getBankById(id);
		%>
<div align="center" class="form-group">
<table>

			<input type="hidden" name="sname" value="<%=ba.getSocietyName()%>">
			<tr>
<td> BankName:</td><td> <input type="text" name="bankname"value="<%=ba.getBankName()%>"> </td>
</tr><tr>
<td> Address: </td><td> <input type="text" name="address"value="<%=ba.getAddress()%>"> </td>
</tr><tr>
<td> City:</td><td> <input type="text" name="city"value="<%=ba.getCity()%>"> </td>
</tr><tr>
<td> Pincode:</td><td> <input type="text" name="pincode"value="<%=ba.getPincode()%>"> </td>
</tr><tr>
<td> OpenTime:</td><td> <input type="text" name="opentime"value="<%=ba.getOpenTime()%>"> </td>
</tr><tr>
<td> CloseTime:</td><td> <input type="text" name="closetime"value="<%=ba.getClosedTime()%>"> </td>
</tr><tr>
<td> OpenDay:</td><td> <input type="text" name="openday"value="<%=ba.getOpenDay()%>"> </td>
</tr><tr>
<td> CloseDay:</td><td> <input type="text" name="closeDday"value="<%=ba.getClosedDay()%>"> </td>
</tr><tr>
<td>
