...
<div class="form-body">
	<form method="POST" action="UDATMAction.jsp">
		<%
			String i = request.getParameter("id");
			int id = Integer.parseInt(i);

			ATM at = ATMWorker.getAtmById(id);
		%>
<div align="center" class="form-group">
<table>

			<input type="hidden" name="sname" value="<%=at.getSocietyName()%>">
			<tr>
<td> ATM Name:</td><td> <input type="text" name="atm"value="<%=at.getKM()%>"> </td>
</tr><tr>
<td>Location: </td><td><input type="text" name="location"value="<%=at.getLocation()%>"> </td>
</tr><tr>
<td> KM: </td><td><input type="text" name="km"value="<%=at.getKM()%>"> </td>
</tr><tr>

			 <input type="hidden" name="Id" value="<%=at.getId()%>">
