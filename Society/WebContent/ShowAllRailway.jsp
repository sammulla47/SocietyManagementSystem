					...
					<div class="panel panel-widget forms-panel">
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
	<%
		List<RailwayStation> List = RailwayStationWorker.getAllRailwayStation();
	%>
	<div align="center">
		<marquee>
		...
		<table border="2" cellspacing="1">
			...
			<%
				for (RailwayStation rs : List) {
					int id = rs.getId();
			%>
			<tr>
				<th><a href="ShowByRailwayStationId.jsp?id=<%=id%>"><%=rs.getId()%></a></th>
			
				<th><%=rs.getLocation()%></th>
				<th><%=rs.getKM()%></th>
			<%
				}
			%>
