						...
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								<div class="form-title">
									<h4>Add RaiwayStation :</h4>
								</div>
								<div class="form-body">
								
<form method="Post" action="RailwayStationAction.jsp">
...
<tr><td>Location</td> <td> <input type="text" name="location"  maxlength="50" size="30" required></td></tr>

<tr><td>KM</td> <td><input type="number" name="km"  maxlength="50" size="30" required ></td></tr>


<tr><td colspan="2"><p align="center"><br/><input type="submit" class="btn btn-deflat" value="Add RailwayStation"></p></td></tr>
